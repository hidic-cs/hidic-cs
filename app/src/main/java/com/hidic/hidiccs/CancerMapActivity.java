...
public class CancerMapActivity extends FragmentActivity implements OnMapReadyCallback ,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cancermaps);
    ...
    public void onLocationChanged(Location location) {
        ...
        LatLng knh = new LatLng(-1.300871,36.808372);
        mMap.addMarker(new MarkerOptions().position(knh).title("Kenyatta National Hospital"));
        ...
        LatLng kimh = new LatLng(-0.953966,36.593195);
        mMap.addMarker(new MarkerOptions().position(kimh).title("Kijabe Mission Hospital"));

        LatLng maho = new LatLng(-1.306969,36.8341);
        mMap.addMarker(new MarkerOptions().position(maho).title("Mater Hospital"));
